...
//var ran = { romney: false, obama: false };
  ...
  if ($routeParams.query) {
     ...
     $http.jsonp('https://jlank.iriscouch.com/wapohack/_design/lists/_view/by_speaker_organization_date?startkey=[%22'+candidate+'%22,%22'+$routeParams.query+'%22,{}]&endkey=[%22'+candidate+'%22,%22'+$routeParams.query+'%22]&descending=true&callback=JSON_CALLBACK')
